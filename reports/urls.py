...
from signaux.views import ToBeApprovedListView 
from .views import ApprovedReportListView, ListReport, RejectedReportListView, ReportDetail, RequestChangeReportListView, ToBeApprovedReportsUpdateView,UpdateReportView
urlpatterns =[
    ...
    path('Pending_reports',ToBeApprovedListView.as_view()),
